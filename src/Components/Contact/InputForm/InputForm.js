        ...
        <div className="email-container">
            <div className="form m-4">
                <form className="w-75 mx-auto" onSubmit={handleReistration}>
                    ...
                    <button type="submit" className="btn btn-primary">{isLogIn ? 'Log In' : 'Register Now'}</button>
                    <br />
                    <button onClick={handleResetPassword} type="button" className="my-2 btn btn-primary btn-sm">Reset Password</button>
                </form>
            </div>
        </div>
    );
